...
public static class ObjectExtensions
{
    ...
    /// <param name="info">The info of the method</param>
    /// <param name="list">parameters</param>
    public static object InvokeMethod(this object obj, MethodInfo info, params object[] list)
    {
        try
        {
            if (info == null) return null;

            return info?.Invoke(obj, list);
        }
        catch
        {
            // ignored
    ...
    /// <param name="info">The info of the method</param>
    /// <param name="list">parameters</param>
    public static T InvokeMethod<T>(this object obj, MethodInfo info, params object[] list)
    {
        try
        {
            if (info == null) return default;

            return (T)info?.Invoke(obj, list);
        }
        catch
        {
            // ignored
    ...
    /// <param name="info">The info of the field</param>
    /// <param name="value">The value to set</param>
    public static void SetField(this object obj, FieldInfo info, object value)
    {
        try
        {
            if (info == null) return;
    ...
    public static void SetField<T>(this object obj, FieldInfo info, T value)
    {
        try
        {
            if (info == null) return;
    ...
    /// <param name="info">The info of the field</param>
    public static object GetField(this object obj, FieldInfo info)
    {
        try
        {
            if (info == null) return default;
    ...
    /// <param name="info">The info of the field</param>
    /// <typeparam name="T">Type of value</typeparam>
    public static T GetField<T>(this object obj, FieldInfo info)
    {
        try
        {
            if (info == null) return default;
    ...
    /// <param name="info">The info of the property</param>
    /// <param name="value">The value to set</param>
    public static void SetProperty(this object obj, PropertyInfo info, object value)
    {
        try
        {
            if (info == null) return;
            ...
            if (info.CanWrite)
                ...
                obj.SetField($"<{info.Name}>k__BackingField", value);
        }
        catch (System.ArgumentException e)
        {
    ...
    /// <param name="value">The value to set</param>
    /// <typeparam name="T">Type of value</typeparam>
    public static void SetProperty<T>(this object obj, PropertyInfo info, T value)
    {
        try
        {
            if (info == null) return;
            ...
            if (info.CanWrite)
                ...
                obj.SetField<T>($"<{info.Name}>k__BackingField", value);
        }
        catch (System.ArgumentException e)
        {
            LogConvert(e, "property");
    ...
    /// <param name="obj">The object to get the value from</param>
    /// <param name="info">The info of the property</param>
    public static object GetProperty(this object obj, PropertyInfo info)
    {
        try
        {
            if (info == null) return default;

            return info.CanRead ? info.GetValue(obj, null) : obj.GetField($"<{info.Name}>k__BackingField");
        }
        catch
        {
            // ignored
    ...
    /// <param name="info">The info of the property</param>
    /// <typeparam name="T">Type of value</typeparam>
    public static T GetProperty<T>(this object obj, PropertyInfo info)
    {
        try
        {
            if (info == null) return default;

            return info.CanRead ? (T)info.GetValue(obj, null) : obj.GetField<T>($"<{info.Name}>k__BackingField");
        }
        catch
        {
            // ignored
...
namespace SALT.Extensions
{
    public static class ObjectExtensions
    {
        ...
        /// Clones the object
        /// </summary>
        [Obsolete("Use UnityObjectExtensions.Instantiate instead.")]
        public static T CloneInstance<T>(this T obj) where T : Object => UnityObjectExtensions.Instantiate(obj);
    }
}