namespace System.Collections.Generic
{
	...
	public class BidirectionalDictionary<T1, T2> : IEnumerable
	{
		...
		public IReadOnlyDictionary<T1, T2> Forward => t1ToT2Dict.ToDictionary(pair => pair.Key, pair => pair.Value);
		public IReadOnlyDictionary<T2, T1> Reverse => t2ToT1Dict.ToDictionary(pair => pair.Key, pair => pair.Value);
