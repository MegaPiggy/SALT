...
namespace System
{
    ...
    /// <remarks>
    /// Note:<br/>
    ///     Half is not fast enough and precision is also very bad, <br/>
    ///     so it should not be used for mathematical computation (use <see cref="Single"/> instead).<br/>
    ///     The main advantage of Half type is lower memory cost: two bytes per number. <br/>
    ///     Half is typically used in graphical applications.<br/>
    ///     <br/>
    /// Note: <br/>
    ///     All functions, where is used conversion half-><see cref="float"/>/<see cref="float"/>->half, <br/>
    ///     are approx. ten times slower than <see cref="float"/>-><see cref="double"/>/<see cref="double"/>-><see cref="float"/>, i.e. ~3ns on 2GHz CPU.<br/>
    /// </remarks>
    [Serializable]
    ...
    /// <summary>
    /// Helper class for <see cref="Half"/> conversions and some low level operations.<br/>
    /// This class is internally used in the <see cref="Half"/> class.
    /// </summary>
